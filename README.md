...
Что бы использовать заготовленные скрипты, зайдите в Django Shell - таким способом:
...
И импортируйте библиотеку - вот таким способом:

```
from datacenter.modules import *
```

Что бы использовать скрипт в shell, скопируйте его из файла и вставьте в shell.
...
```
schoolkid = get_schoolkid("Иван Петров")
```
